"""Endpoint Vercel Cron — briefing diário às 07:00 (America/Sao_Paulo)."""
...
from services.jobs import load_config_from_env, run_daily_news_job
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:  # noqa: N802
        ...
        try:
            result = run_daily_news_job(config)
