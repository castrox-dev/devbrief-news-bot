...
COLOR_CARD: Final[str] = "#0a0a0a"
COLOR_BORDER: Final[str] = "#262626"
COLOR_RED: Final[str] = "#E53935"
COLOR_RED_DARK: Final[str] = "#B71C1C"
COLOR_TEXT: Final[str] = "#f5f5f5"
COLOR_MUTED: Final[str] = "#a3a3a3"
        ...
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" border="0" style="max-width:600px;width:100%;">
          <tr>
            <td style="background:{COLOR_CARD};border:1px solid {COLOR_BORDER};border-radius:16px 16px 0 0;padding:28px 32px 20px;text-align:center;">
              ...
              <div style="height:3px;background:linear-gradient(90deg,{COLOR_RED_DARK},{COLOR_RED},{COLOR_RED_DARK});border-radius:999px;"></div>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="background:{COLOR_BLACK};border:1px solid {COLOR_BORDER};border-top:none;border-radius:0 0 16px 16px;padding:20px 32px;text-align:center;">
              <p style="margin:0 0 8px;font-size:13px;color:{COLOR_MUTED};">
                ...
                <span style="color:{COLOR_RED};">News</span> · Inteligência diária para quem decide
              </p>
              <p style="margin:0;font-size:12px;color:{COLOR_MUTED};">
                <a href="{SITE_URL}" style="color:{COLOR_RED};text-decoration:none;">devbrief-news.vercel.app</a>
                · RM Sys
              </p>
            </td>
          </tr>
...
def _cta_button(label: str, href: str) -> str:
    ...
    return f"""
      <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" style="margin:28px auto 8px;">
        <tr>
          <td style="border-radius:999px;background:linear-gradient(135deg,{COLOR_RED},{COLOR_RED_DARK});">
            <a href="{safe_href}" style="display:inline-block;padding:14px 28px;font-size:15px;font-weight:700;color:{COLOR_WHITE};text-decoration:none;">
              {safe_label}
            </a>
          </td>
        </tr>
...
def render_welcome_email(subscriber_email: str) -> tuple[str, str]:
    ...
    body = f"""
      <h1 style="margin:24px 0 12px;font-size:28px;line-height:1.25;color:{COLOR_WHITE};font-weight:800;">
        Bem-vindo ao <span style="color:{COLOR_RED};">DevBrief News</span>
      </h1>
      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:{COLOR_BLACK};border:1px solid {COLOR_BORDER};border-radius:12px;">
        <tr>
          <td style="padding:20px 22px;">
            <p style="margin:0 0 14px;font-size:13px;font-weight:700;color:{COLOR_RED};text-transform:uppercase;letter-spacing:0.06em;">
              O que você recebe
            </p>
...
def render_team_notification_email(subscriber_email: str) -> tuple[str, str]:
    ...
    body = f"""
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:24px;">
        <tr>
          <td style="background:linear-gradient(135deg,{COLOR_RED}22,{COLOR_BLACK});border:1px solid {COLOR_BORDER};border-radius:12px;padding:18px 20px;">
            <p style="margin:0 0 6px;font-size:12px;font-weight:700;color:{COLOR_RED};text-transform:uppercase;letter-spacing:0.08em;">
              Nova inscrição
            </p>
      ...
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin-top:20px;background:{COLOR_BLACK};border:1px solid {COLOR_BORDER};border-radius:12px;">
        <tr>
          <td style="padding:22px;">
            ...
            <p style="margin:0;font-size:22px;font-weight:700;color:{COLOR_RED};word-break:break-all;">{email_safe}</p>
          </td>
        </tr>
      </table>
        ...
        <tr>
          ...
          <td width="50%" style="padding-left:8px;">
            <div style="background:{COLOR_BLACK};border:1px solid {COLOR_BORDER};border-radius:10px;padding:16px;text-align:center;">
              ...
              <p style="margin:0;font-size:15px;font-weight:700;color:{COLOR_RED};">Newsletter</p>
            </div>
          </td>
        </tr>
      </table>
